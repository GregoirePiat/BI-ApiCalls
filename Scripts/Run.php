...
$trafficApi = new \ApiCalls\ApiCall("https://download.data.grandlyon.com/ws/rdata/pvo_patrimoine_voirie.pvotrafic/all.json?compact=false&start=1001&maxfeatures=2000", "TRAFFIC", true);
